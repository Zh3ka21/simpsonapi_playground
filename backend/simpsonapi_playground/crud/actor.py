...
def create_actor(db: Session, data: ActorCreate) -> Actor | None:
...
def read_actors(
    ...
    sort_column_map: dict[str, ColumnElement[Any]] = {
        "id": Actor.id,
        "first_name": Actor.first_name,
        "last_name": Actor.last_name,
        "cast": Actor.cast,
    }
    sort_column: ColumnElement[Any] = sort_column_map.get(sort, Actor.first_name)
    if order == "asc":
