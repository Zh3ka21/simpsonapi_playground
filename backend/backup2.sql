...
\restrict Tg7xdvIB3lFMHtUpc1A4O257boiK0NQNibqIjR7sfrz80nGGdwoxxVl0AMeCbh9
...
SELECT pg_catalog.setval('public.characters_id_seq', 85, true);
...
--
-- Name: actors idx_16548_actors_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.actors
    ADD CONSTRAINT idx_16548_actors_pkey PRIMARY KEY (id);


--
-- Name: catchphrases idx_16555_catchphrases_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.catchphrases
    ADD CONSTRAINT idx_16555_catchphrases_pkey PRIMARY KEY (id);


--
-- Name: characters idx_16562_characters_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.characters
    ADD CONSTRAINT idx_16562_characters_pkey PRIMARY KEY (id);


--
-- Name: episodes idx_16569_episodes_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.episodes
    ADD CONSTRAINT idx_16569_episodes_pkey PRIMARY KEY (id);


--
-- Name: quotes idx_16576_quotes_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.quotes
    ADD CONSTRAINT idx_16576_quotes_pkey PRIMARY KEY (id);


--
-- Name: seasons idx_16583_seasons_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.seasons
    ADD CONSTRAINT idx_16583_seasons_pkey PRIMARY KEY (id);


--
-- Name: schema_migrations idx_16587_sqlite_autoindex_schema_migrations_1; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.schema_migrations
    ADD CONSTRAINT idx_16587_sqlite_autoindex_schema_migrations_1 PRIMARY KEY (version);


--
-- Name: ar_internal_metadata idx_16592_sqlite_autoindex_ar_internal_metadata_1; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.ar_internal_metadata
    ADD CONSTRAINT idx_16592_sqlite_autoindex_ar_internal_metadata_1 PRIMARY KEY (key);


--
-- Name: idx_16555_index_catchphrases_on_character_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_16555_index_catchphrases_on_character_id ON public.catchphrases USING btree (character_id);


--
-- Name: idx_16562_index_characters_on_actor_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_16562_index_characters_on_actor_id ON public.characters USING btree (actor_id);


--
-- Name: idx_16569_index_episodes_on_season_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_16569_index_episodes_on_season_id ON public.episodes USING btree (season_id);


--
-- Name: idx_16576_index_quotes_on_character_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_16576_index_quotes_on_character_id ON public.quotes USING btree (character_id);


--
-- Name: idx_16576_index_quotes_on_episode_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_16576_index_quotes_on_episode_id ON public.quotes USING btree (episode_id);
...
\unrestrict Tg7xdvIB3lFMHtUpc1A4O257boiK0NQNibqIjR7sfrz80nGGdwoxxVl0AMeCbh9
